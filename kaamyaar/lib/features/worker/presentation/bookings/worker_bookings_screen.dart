...
class _WorkerBookingsScreenState extends ConsumerState<WorkerBookingsScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final bookingsAsync = ref.watch(workerBookingsProvider(user.id));
      ...
      body: bookingsAsync.when(
        data: (bookings) {
          final activeBookings = bookings
              .where((b) => !['completed', 'cancelled', 'pending'].contains(b.status))
              .toList();
      ...
      itemBuilder: (context, index) {
        ...
        return Card(
          ...
          child: InkWell(
            ...
            onTap: () {
              // Usually route to ActiveJobScreen or detail view
            },
            child: Padding(
              padding: const EdgeInsets.all(16),
              child: Column(
...
final workerBookingsProvider =
  ...
  return repo.getWorkerBookings(workerId);
});
